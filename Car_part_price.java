...
class Engine extends Part_price_data{
	Engine(int i){
		price = i;
	}
}
class Aircond extends Part_price_data{
	Aircond(int i){
		price = i;
	}
}
class Sound extends Part_price_data{
	Sound(int i){
		price = i;
	}
}
...
public class Car_part_price {
	...
	public static void main(String[] args) {
		...
		Engine cc_1600 = new Engine(20000);
		cc_1600.name = "1600cc engine";
		Engine cc_2000 = new Engine(25000);
		cc_2000.name = "2000cc engine";
		Aircond auto = new Aircond(12000);
		auto.name = "auto AC";
		Aircond manual = new Aircond(10000);
		manual.name = "manual AC";
		Sound sound = new Sound(2000);
